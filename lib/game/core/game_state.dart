  ...
  static GameState initial(GameDefinitions definitions) {
    ...
    return GameState(
      ...
      inventory: const [
        ...
        InventoryEntry(itemId: 'novice_hat', count: 1),
        InventoryEntry(itemId: 'novice_cloth', count: 1),
        InventoryEntry(itemId: 'novice_wristguards', count: 1),
        InventoryEntry(itemId: 'novice_pants', count: 1),
        InventoryEntry(itemId: 'novice_shoes', count: 1),
        InventoryEntry(itemId: 'wooden_necklace', count: 1),
        InventoryEntry(itemId: 'rusty_sword', count: 1),
